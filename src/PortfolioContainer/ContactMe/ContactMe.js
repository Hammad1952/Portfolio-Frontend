...
//       };
//       setBool(true);
//       const res = await axios.post("https://your-backend.onrender.com/api/contact", data);
//       if (
//         name.length === 0 ||
//         email.length === 0 ||
...
//             <h3 style={{ marginBottom: '0.5rem', fontSize: '1.25rem', color: 'white' }}>Contact Number</h3>
//             <a 
//               href="https://wa.me/923425428519" 
//               target="_blank" 
  ...
  const submitForm = (e) => {
    ...
    emailjs
      .send(
        ...
        "nTE76UNC5962EveAJ"    // 🔹 Replace with EmailJS Public Key
      )
      .then(
        (result) => {
